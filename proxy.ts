...
function buildCsp(nonce: string): string {
  ...
  return [
    ...
    `connect-src 'self' ${backendUrl} https://kasyaf-ai-agent.my.id https://www.kasyaf-ai-agent.my.id https://raw.githack.com https://raw.githubusercontent.com https://api.groq.com https://cdn.jsdelivr.net https://unpkg.com https://lottie.host https://*.lottiefiles.com wss://*.sylvorlabs.com wss://${backendUrl.replace('https://','')} ws://localhost:* wss://localhost:* http://localhost:* https://unpkg.com`,
